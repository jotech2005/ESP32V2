...
public class SensorDataController {
    ...
    public ResponseEntity<Map<String, Object>> createSensorData(@RequestBody SensorData sensorData) {
        try {
            ...
            // ✅ Usa fechaCreacion (lo que estás usando en el repo)
            response.put("fechaCreacion", savedData.getFechaCreacion());
    ...
    public ResponseEntity<Map<String, Object>> getLatestReadings(@PathVariable int limit) {
        try {
            ...
            List<SensorData> data = sensorDataService.getLastNReadings(safeLimit);
    ...
    public ResponseEntity<Map<String, Object>> updateSensorData(
        ...
        try {
            Optional<SensorData> updatedOpt = sensorDataService.updateSensorData(id, sensorData);
